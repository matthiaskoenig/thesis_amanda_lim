...
In this project, the effects of dosing, inter-individual variability, and comorbid conditions on hydrochlorothiazide pharmacokinetics and pharmacodynamics were investigated using computational modeling. Specifically, a physiologically-based pharmacokinetic/pharmacodynamic (PBPK/PD) model of hydrochlorothiazide was developed to systematically address the following questions:
- What are the effects of different administered doses of hydrochlorothiazide on its pharmacokinetics and pharmacodynamics?
- How do inter-individual factors such as body weight and demographic variability influence hydrochlorothiazide disposition and response?
- What are the effects of renal impairment, hepatic impairment, or congestive heart failure on hydrochlorothiazide pharmacokinetics and pharmacodynamics?
The overarching objective is to advance the mechanistic understanding of inter-individual variability in blood pressure regulation and diuretic response through hydrochlorothiazide. Such insights could support optimized dosing strategies and improved therapeutic outcomes in diverse patient populations.


// Within this project the effects of different dosing, genetic variants (genotypes) of key proteins involved in losartan metabolism and hepatic and renal impairment on losartan pharmacokinetics and pharmacodynamics were studied utilizing computational modelling. Specifically, a physiological-based pharmacokinetic/ pharmacodynamic (PBPK/PD) model of losartan was developed to systematically analyse the following questions:

// - What are the effects of different administered doses of losartan on its pharmacokinetics and pharmacodynamics?
// - What are the effects of genetic variants of CYP2C9 or ABCB1 genotypes on losartan pharmacokinetics and pharmacodynamics?
// - What are the effects of renal or hepatic impairment on losartan pharmacokinetics and pharmacodynamics?

// The objective is to improve our understanding of the underlying causes of inter-individual variability in blood pressure regulation through ARBs such as losartan, which could be used further to optimize treatment strategies and improve patient outcomes.