...
Cardiac (↓ GI-tract perfusion ↓ aborption)
...
== Limitations of Data
 ...
 One study (Beermann1976) exhibited values inconsistent with physiologically plausible concentration ranges and deviated substantially from all other clinical datasets. Despite extensive review the discrepancy could not be reconciled and likely reflects a unit or reporting error in the original source. Accordingly this outlier dataset was excluded from model calibration and evaluation.
